...
for aaa in aaaa:
    for aa in aaa[::-1]:
        ...
        if i is 0:
            ax1.vlines(aa.tus[aa.tr0]-tshift, -.55, 0)
            ax1.vlines(aa.tus[aa.tr1]-tshift, -.55, 0)
            #ax1.vlines(aa.tus[aa.tr3]-tshift, -.55, 0)
            ax1.vlines(23, -.55, 0)
            ax1.annotate(s='', xy=(-aa.Ton, -.52), xytext=(0, -.52), arrowprops=dict(arrowstyle='<->'))
            ...
            ax1.text(-aa.Ton*0.6, -.5, r"$T_{on}$")
            #ax1.text(aa.tus[aa.tr3-aa.tr1]*0.45, -.5, r"$T_{deflation}$")
            ax1.text(11, -.5, r"$T_{deflation}$")
        i+=1
ax1.legend(loc='best')
ax1.grid()
