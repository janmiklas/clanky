...
#for i in range(1,2):
    ...
    ax11.plot(TTTon, qqq, 'o', color=colors[i], label=r'$Q$') #label=r'Q, $I_{B-}=$'+f'{Ibpos}A')
    ax11.plot(TTTon, qqq1, 's', color=colors[i], label=r'$Q_1$')
    ax11.plot(TTTon, qqq2, 'd', color=colors[i], label=r'$Q_2$')
